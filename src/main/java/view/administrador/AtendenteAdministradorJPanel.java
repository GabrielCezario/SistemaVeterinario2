...
public class AtendenteAdministradorJPanel extends JPanel {
	private JTextField txtNome;

	/**
	 * Create the panel.
	 */
	public AtendenteAdministradorJPanel() {
		setLayout(null);
		...
		JButton btnTpoAnimal = new JButton("Tipo Animal");
		btnTpoAnimal.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		btnTpoAnimal.setFont(new Font("Arial Black", Font.BOLD, 12));
		btnTpoAnimal.setBounds(0, 123, 200, 41);
		panelMenu.add(btnTpoAnimal);
		
		JLabel lblNome = new JLabel("Nome");
		lblNome.setBounds(210, 102, 46, 14);
		add(lblNome);
		
		txtNome = new JTextField();
		txtNome.setColumns(10);
		txtNome.setBounds(210, 127, 247, 26);
		add(txtNome);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Main.getFrame().setContentPane(new CadastroAtendentesAdministradorJPanel());
				Main.getFrame().getContentPane().revalidate();
				
			}
		});
		btnCadastrar.setBounds(525, 195, 209, 32);
		add(btnCadastrar);
		...
		JList listNome = new JList();
		scrollPane.setViewportView(listNome);
		
		ControlladorAtendente controlladorAtendente = new ControlladorAtendente();
		List<Atendente> listAtendente = controlladorAtendente.listarAtendentes();
		listNome.setListData(listAtendente.toArray());
		...
		btnBuscar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				ControlladorAtendente ControlladorAtendente = new ControlladorAtendente();
				List<Atendente> listAtendente = controlladorAtendente.listarAtendentesPorNome(nome);
				listNome.setListData(listAtendente.toArray());
		...
		btnVisualizar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				CadastroAtendentesAdministradorJPanel.atendenteTela = (Atendente) listNome.getSelectedValue();
		...
		btnVisualizar.setBounds(525, 238, 209, 32);
		add(btnVisualizar);
		...
		btnDeletar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					Atendente atendente = (Atendente) listNome.getSelectedValue();
					
					ControlladorAtendente controlladorAtendente = new ControlladorAtendente();
					controlladorAtendente.deletarAtendente(atendente);
		...
		btnDeletar.setBounds(525, 281, 209, 32);
		add(btnDeletar);
