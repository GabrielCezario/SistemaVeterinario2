...
public class CadastroVeterinariosAdministradorJPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public CadastroVeterinariosAdministradorJPanel() {
		setLayout(null);
		...
		JButton btnTipoAnimal = new JButton("TipoAnimal");
		...
		JLabel lblCadastrarVeterinario = new JLabel("Cadastrar veterinario");
		lblCadastrarVeterinario.setHorizontalAlignment(SwingConstants.CENTER);
		lblCadastrarVeterinario.setFont(new Font("Arial Black", Font.BOLD, 14));
		lblCadastrarVeterinario.setBounds(362, 51, 294, 20);
		add(lblCadastrarVeterinario);
		...
		List<TipoEspecialidade> listTipoEspecialidade = ControlladorTipoEspecialidade.listarTiposEspecialidades();
		
		JComboBox cboEspecialidade = new JComboBox(listTipoEspecialidade.toArray());
		cboEspecialidade.setBounds(606, 212, 188, 20);
		add(cboEspecialidade);		
		
		JLabel lblEspecialidade = new JLabel("Especialidade*");
		lblEspecialidade.setFont(new Font("Arial", Font.PLAIN, 14));
		lblEspecialidade.setBounds(606, 189, 103, 14);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				veterinario.setSobrenome(txtSobrenome.getText());
				veterinario.setTelefone(txtTelefone.getText());

				List<TipoEspecialidade> listaEspecialidadeDeVeterinario = veterinario.getTipoEspecialidade();
				TipoEspecialidade tipoEspecialidade = (TipoEspecialidade) cboEspecialidade.getSelectedItem();
				
				listaEspecialidadeDeVeterinario.add(tipoEspecialidade);
				
				veterinario.setTipoEspecialidade(listaEspecialidadeDeVeterinario);
				...
				try {
					...
					controlladorVeterinario.cadastrarVeterinario(veterinario);
		...
		btnCadastrar.setBounds(681, 557, 109, 32);
		add(btnCadastrar);
