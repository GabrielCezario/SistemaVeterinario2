...
public class CadastrarRelatorioAdministradorJPanel extends JPanel {
	 ...
	 * Create the panel.
	 */
	public CadastrarRelatorioAdministradorJPanel() {
		setLayout(null);
		...
		btnAtendentes.setBounds(0, 160, 200, 41);
		...
		btnVeterinarios.setBounds(0, 201, 200, 41);
		...
		btnTipo.setBounds(0, 241, 200, 41);
		...
		btnTipoAnimal.setBounds(0, 120, 200, 41);
		...
		JButton btnCadastrarRelatorio = new JButton("Cadastrar");
		btnCadastrarRelatorio.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		btnCadastrarRelatorio.setBounds(681, 557, 109, 32);
		add(btnCadastrarRelatorio);
