...
public class CadastroAtendentesAdministradorJPanel extends JPanel {
	...
	protected static Atendente atendenteTela;

	/**
	 * Create the panel.
	 */
	public CadastroAtendentesAdministradorJPanel() {
		setLayout(null);
		...
		btnTipo.setBounds(0, 243, 200, 41);
		...
		JLabel lblCadastrarAtendente = new JLabel("Cadastrar atendente");
		lblCadastrarAtendente.setHorizontalAlignment(SwingConstants.CENTER);
		lblCadastrarAtendente.setFont(new Font("Arial Black", Font.BOLD, 14));
		lblCadastrarAtendente.setBounds(362, 51, 294, 20);
		add(lblCadastrarAtendente);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				atendente.setSobrenome(txtSobrenome.getText());
				...
				try {
					...
					controlladorAtendente.cadastrarAtendente(atendente);
